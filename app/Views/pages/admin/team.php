                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/team/saveAddTeam" method="post" enctype="multipart/form-data"
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control <?= ($validation->hasError('name_team')) ? 'is-invalid' : ''; ?>"
                                                        name="name_team" id="name_team" required>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control <?= ($validation->hasError('position_team')) ? 'is-invalid' : ''; ?>"
                                                        required name="position_team" id="position_team" />
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="mb-3">
                                                    <label for="motivational_words" class="form-label">Enter
                                                        Motivational
                                                        Words</label>
                                                    <input type="text" class="form-control" name="motivational_words"
                                                    ...
                                                    <div class="row ">
                                                        <div class="input-file input-file-image">
                                                            <img class="img-upload-preview mb-2" width="100"
                                                                height="100" src="https://via.placeholder.com/100">
                                                            <input
                                                                class="form-control form-control-file <?= ($validation->hasError('member_img')) ? 'is-invalid' : ''; ?>"
                                                                type="file" id="member_img" name="member_img"
                                                                accept="image/*" required>
                                                            <label for="member_img"
                                                                class="btn btn-primary btn-round mt-2"><i
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="btn__edit me-2">
                                        ...
                                        <button type="button" class="button bg-transparent border-0"
                                            data-bs-toggle="modal" data-bs-target="#modal_<?= $dataTeam['id_team']; ?>">
                                            <i class="bi bi-pencil-square blue"></i>
                                        </button>
                                        <!-- Modal -->

                                        <div class="modal fade" id="modal_<?= $dataTeam['id_team']; ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/team/saveEditTeam/<?= $dataTeam['id_team']; ?>"
                                                        method="post" enctype="multipart/form-data"
                                                        class="needs-validation" novalidate>
                                                        <input type="text" hidden
                                                            name="member_img_old_<?= $dataTeam['id_team']; ?>"
                                                            value="<?= $dataTeam['photo_team']; ?>">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label for="name_team_<?= $dataTeam['id_team']; ?>"
                                                                    class="form-label">Enter member's
                                                                    name<span class="red">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    name="name_team_<?= $dataTeam['id_team']; ?>"
                                                                    id="name_team_<?= $dataTeam['id_team']; ?>" required
                                                                    value="<?= $dataTeam['name_team']; ?>">
                                                                <div class="invalid-feedback">
                                                                    Name is required
                                                                </div>
                                                            </div>
                                                            <!-- member name -->
                                                            <div class="mb-3">
                                                                <label for="position_team_<?= $dataTeam['id_team']; ?>"
                                                                    class="form-label">Enter
                                                                    Position <span class="red">*</span></label>
                                                                <input type="text" class="form-control" required
                                                                    name="position_team_<?= $dataTeam['id_team']; ?>"
                                                                    id="position_team_<?= $dataTeam['id_team']; ?>"
                                                                    value="<?= $dataTeam['position_team']; ?>" />
                                                                <div class="invalid-feedback">
                                                            ...
                                                            <div class="mb-3">
                                                                <label
                                                                    for="motivational_words_<?= $dataTeam['id_team']; ?>"
                                                                    class="form-label">Enter
                                                                    Motivational
                                                                    Words</label>
                                                                <input type="text" class="form-control"
                                                                    name="motivational_words_<?= $dataTeam['id_team']; ?>"
                                                                    id="motivational_words_<?= $dataTeam['id_team']; ?>"
                                                                    value="<?= $dataTeam['motivational_words']; ?>" />
                                                            </div>
                                                            <!-- position member -->
                                                            <div class="mb-3 row">
                                                                ...
                                                                <div class="row ">
                                                                    <div class="input-file"
                                                                        ...
                                                                        <?php } ?>
                                                                        <input hidden
                                                                            class="form-control form-control-file <?= ($validation->hasError('member_img_' . $dataTeam['id_team'])) ? 'is-invalid' : ''; ?>"
                                                                            type="file"
                                                                            id="member_img_<?= $dataTeam['id_team']; ?>"
                                                                            name="member_img_<?= $dataTeam['id_team']; ?>"
                                                                            accept="image/*"
                                                                            value="<?= $dataTeam['photo_team']; ?>">
                                                                        <label
                                                                            for="member_img_<?= $dataTeam['id_team']; ?>"
                                                                            class="btn btn-primary btn-round mt-2"><i
                                                                                class="fa fa-file-image text-white"></i>
                                                                            Upload Image</label>
                                                                        <div class="invalid-feedback">
                                    ...
                                    <div class="btn__hapus">
                                        ...
                                        <button type="button" class="button bg-transparent border-0"
                                            ...
                                            data-bs-target="#modal_hapus_<?= $dataTeam['id_team']; ?>">
                                            <i class="bi bi-trash3-fill red"></i>
                                        </button>
                                        <!-- Modal -->
                                        <div class="modal fade" id="modal_hapus_<?= $dataTeam['id_team']; ?>"
