            ...
            <div class="innovation__content bgdarkgreen">
                ...
                <div class="deskripsi text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn__dropdown btn bg-transparent p-0" type="button" data-bs-toggle="collapse" data-bs-target="#deskripsi_<?= $innovation['id_innovation']; ?>" aria-expanded="false" aria-controls="collapseExample">
                ...
                <div class="uniq mt-2 text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn__dropdown btn bg-transparent p-0" type="button" data-bs-toggle="collapse" data-bs-target="#uniq_<?= $innovation['id_innovation']; ?>" aria-expanded="false" aria-controls="collapseExample">
                            <i class="fa-solid fa-angle-down text-white"></i>
                        </button>
                    </div>
                ...
                <div class="project mt-2 text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn__dropdown btn bg-transparent p-0" type="button" data-bs-toggle="collapse" data-bs-target="#project_<?= $innovation['id_innovation']; ?>" aria-expanded="false" aria-controls="collapseExample">
                            <i class="fa-solid fa-angle-down text-white"></i>
                        </button>
                    </div>
